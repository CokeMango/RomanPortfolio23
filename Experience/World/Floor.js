...
export default class Floor {
  ...
  setCircles() {
    ...
    const material = new THREE.MeshStandardMaterial({ color: 0xFCFAF6});
    ...
    this.circleFirst.position.y = -0.28;
    this.circleSecond.position.y = -0.27;
    this.circleThird.position.y = -0.26;
